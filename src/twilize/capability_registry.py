...
CAPABILITY_SPECS: tuple[CapabilitySpec, ...] = (
    ...
    CapabilitySpec(
        ...
        aliases=("reference line", "reference band"),
        rationale="Constant, aggregate, and band reference lines via add_reference_line/add_reference_band.",
    ),
    CapabilitySpec(
        key="trend-line",
        kind="feature",
        ...
        rationale="Linear, polynomial, log, exp, power trend lines via add_trend_line.",
    ),
    CapabilitySpec(
    ...
    CapabilitySpec(
        ...
        kind="feature",
        level="advanced",
        canonical="CSV Pipeline",
        aliases=("csv to dashboard", "csv pipeline"),
        rationale="End-to-end CSV → schema inference → chart suggestion → Hyper → .twbx pipeline.",
    ),
    CapabilitySpec(
        key="color-palette",
        kind="feature",
        ...
        aliases=("color palette", "custom palette"),
        rationale="Custom color palettes in workbook preferences via apply_color_palette.",
    ),
    CapabilitySpec(
        key="dashboard-theme",
        kind="feature",
        level="advanced",
        canonical="Dashboard Theme",
        aliases=("dashboard theme",),
        rationale="Uniform background and font styling across dashboard zones.",
    ),
    CapabilitySpec(
        key="bin",
        kind="feature",
